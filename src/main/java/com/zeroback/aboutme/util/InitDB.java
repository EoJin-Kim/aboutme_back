...
public class InitDB {
    ...
    static class InitService{
        ...
        public void dbInit1() {
            ...
            Member member = createMember("김어진","", "test@test.com", "안녕하세요", "개발자", "010-2341-1411", tags1);


            List<String> tags2 = Arrays.asList("백엔드22", "프론트22", "안드로이드22");
            Member member2 = createMember("김두한", "1.jpg","test2@test.com", "안녕하세요22", "개발자22", "010-2341-141122",tags2 );
            Member member3 = createMember("사자", "2.jpg","test3@test.com", "사자입니다!!", "배우", "010-2341-141122",tags2 );
            Member member4 = createMember("팽귄", "3.jpg","test4@test.com", "안녕하세요22", "개그맨", "010-2341-141122",tags2 );
            Member member5 = createMember("호랑이","4.jpg", "test5@test.com", "안녕하세요22", "애널리스트", "010-2341-141122",tags2 );
            Member member6 = createMember("기린","5.jpg", "test6@test.com", "안녕하세요22", "치킨집 사장", "010-2341-141122",tags2 );
            Member member7 = createMember("고양이", "6.jpg","test7@test.com", "안녕하세요22", "마트 직원", "010-2341-141122",tags2 );
...
//            MemberTeam.create(member,team3);
        ...
        private Member createMember(String name, String image , String email, String content, String job, String phone, List<String> tags) {
